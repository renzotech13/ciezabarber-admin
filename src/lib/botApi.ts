...
const MENSAJES_ERROR: Record<string, string> = {
  ...
  servicio_no_encontrado: "Ese servicio ya no existe.",
  conflicto_horario: "Ese barbero ya tiene algo a esa hora. Corrige la hora.",
  fuera_de_politica: "Ese horario no cae dentro del horario de atención.",
  solo_tus_servicios: "Solo puedes registrar servicios a tu nombre.",
  invalid_body: "Faltan datos o alguno quedó mal escrito.",
